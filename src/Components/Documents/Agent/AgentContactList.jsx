...
const AgentContactList = () => {
    ...
    useEffect(() => {
        ...
        fetch(API_ROUTES.getAgentChatList)
            ...
            .then((data) => {
                const filteredChatList = data.filter(contact => contact.chatStatus === 'Active');
                setChatList(filteredChatList);
                setIsLoading(false);
                console.log("Agent chat List ", filteredChatList);
            })
            .catch((error) => {
                                            ...
                                            <div>
                                                {(isMobile && currentChat) ? (
                                                    <div>
                                                        ...
                                                        <AgentDocuments currentChat={currentChat} />
                                                    </div>
                                                ) :
