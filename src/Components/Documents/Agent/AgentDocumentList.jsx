...
function AgentDocumentList({ documentType, documents, handleFileChange, setDocumentType, handleReject, handleAccept }) {
                                    ...
                                    <Grid container spacing={2} sx={{ alignItems: "center" }}>
                                        ...
                                        <Grid item xs={12} md={5}>
                                            ...
                                            <Box sx={{
                                                ...
                                                {(document.agentVerificationStatus === 'Rejected') && (<div class="ver-btns" onClick={() => handleAccept(document?.sailDocumentId)} >
                                                    <TaskAltIcon style={{ color: '#20CD50' }} />
                                                    <span>{t("accept")}</span>
                                                </div>)}
                                                {(document.agentVerificationStatus === 'Approved') && (<div class="ver-btns" onClick={() => handleReject(document?.sailDocumentId)}>
                                                    <CancelIcon style={{ color: '#FF2E00' }} />
                                                    <span>{t("reject")}</span>
                                                </div>)}
                                                {(document.agentVerificationStatus === 'Pending') && (
