...
function ChatScreen({ socket }) {
  ...
  const handleChatChange = (chat) => {
    fetch(API_ROUTES.setReadFlag(chat?.chatId), {
      method: "POST"
    })
      .then((response) => {
        if (!response.ok) {
      ...
      .then((data) => {
        console.log("Setting Read flag response", data);
        if (data === "Done") {
      ...
      .catch((error) => {
        console.error("setReadFlag API request failed:", error);
      });
                        ...
                        {(isMobile && currentChat) ? (
                          ...
                          (isMobile || showContactsOnly) ?
                            (<div className="chat-screen">
                              <div className="contact-list-buyer">
                            ...
                            (<div className="chat-screen">
                              ...
                              <div className="message-screen-buyer">
