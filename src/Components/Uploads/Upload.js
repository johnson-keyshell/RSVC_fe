...
export default function Uploads() {
    return (
        ...
        <div className="rectangle-box">
            <div className='row' style={{right:"-10px",display:'flex',justifyContent:'space-between'}}>
            <p className='title'>
                {t("uploadFile")}
            </p>
            ...
            <div className='upload-Button'>
                ...
                <Typography variant="body2" component="h1">
                    Accepted file types .jpeg, .pdf, .doc
                </Typography>
                {/* Column 3 */}
                <Button sx={{ backgroundColor: "#54C7E9", borderRadius: "20px" }} variant="contained" >
                    {t("chooseFile")}
