import '../Seller/SellerDetailsPage/SellerDetailsPage.css'
...
function AgentPropertyDetails({ nextStep, formData, setFormData }) {
      ...
      {isLoading ? (<Loader />) : (<div>
        ...
        <div class="details-page" >
          ...
          >
            ...
            >
              <Button class="editBtn">Edit Listing</Button>
            </Box> */}
            </Box>
              ...
              <div class="row-amenity">
                <Grid container spacing={3}>
                  <Grid item xs={6} md={3}>
                    ...
                    >
                      <Typography class='amenity-type'>{t("totalSqFeet")}</Typography>
                      <Typography class='amenity-type-content-se'>2000</Typography>
                    </Box>
                  ...
                  <Grid item xs={6} md={3}>
                    ...
                    >
                      <Typography class='amenity-type'>{t("totalNoOfFloors")}</Typography>

                      <Typography class='amenity-type-content-se'>2 </Typography>
                    </Box>
                  </Grid>
                  ...
                  <Grid item xs={6} md={3}>
                    ...
                    >
                      <Typography class='amenity-type'>{t("houseType")}</Typography>

                      <Typography class='amenity-type-content-se'>{t("independant")}</Typography>
                    </Box>
                  </Grid>
                  <Grid item xs={6} md={3}>
                    <Box
                    ...
                    >
                      <Typography class='amenity-type'>Lorem ipsum</Typography>

                      <Typography class='amenity-type-content-se'>2 {t("bathrooms")}</Typography>
                    </Box>
              ...
              <div class="row-amenity">
                ...
                <Grid container spacing={3}>
                  <Grid item xs={6} md={3}>
                    ...
                    >
                      <Typography class='amenity-type'>{t("ageOfBuilding")}</Typography>

                      <Typography class='amenity-type-content-se'>2 {t("years")}</Typography>
                    </Box>
                  </Grid>
                  ...
                  <Grid item xs={6} md={3}>
                    ...
                    >
                      <Typography class='amenity-type'>{t("parking")} </Typography>

                      <Typography class='amenity-type-content-se'>{t("basement")}</Typography>
                    </Box>
                  </Grid>
                  <Grid item xs={6} md={3}>
                    <Box
                    ...
                    >
                      ...
                      <Typography class='amenity-type-content-se'>2wf</Typography>
                    </Box>
                  </Grid>
                  <Grid item xs={6} md={3}>
                    <Box
                    ...
                    >
                      ...
                      <Typography class='amenity-type-content-se'>sdfjbweibf</Typography>
                    </Box>
